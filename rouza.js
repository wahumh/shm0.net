var rid='1885db8371dx16f0b8e5x69w81x';
...
background-image: url(https://up6.cc/2023/05/168520062792932.png); background-size: cover;color: #666666;
}`);


$(`<style>
.nosel.d-flex.room.r1885db8371dx16f0b8e5x69w81x .fitimg.u-pic.borderg {
  letter-spacing: 1px;
  background-size: 108% 108%;
  -webkit-text-fill-color: white;
  animation: grad 2s cubic-bezier(.445,.05,.55,.95) alternate infinite;
}
.nosel.d-flex.room.r1885db8371dx16f0b8e5x69w81x .corner.fa.fa-user.label.uc.fa-microphone.label-danger {
  letter-spacing: 1px;
  -webkit-text-fill-color: #995b85;
...
.nosel.d-flex.room.r1885db8371dx16f0b8e5x69w81x.bord {border-inline: 0px solid #4c121e !important;}
.nosel.d-flex.room.r1885db8371dx16f0b8e5x69w81x .dots.mini.u-msg {
    text-align: center;
...
.nosel.d-flex.room.r1885db8371dx16f0b8e5x69w81x {
    background-image: url(https://up6.cc/2023/05/168520062794553.jpg);
...
.nosel.d-flex.room.r1885db8371dx16f0b8e5x69w81x .u-topic.dots {
...
#d0.mshanaa1 {
  ...
  background-image: url(https://up6.cc/2023/05/168520062792932.png);
  background-size: cover;
}
#d2.mshanaa1 .label-primary{background-color:#b77c9a!important}#d2.mshanaa1 .bg{background-color:#b77c9a!important}#d2.mshanaa1 .uzr.d-flex.mm.hmsg{border-radius: 10px 0 10px;background-color:#d9cfc19e!important}#dpnl.mshanaa1{background-size: 100%;background-image: url(https://up6.cc/2023/05/168520062792932.png);background-color: #b2b2b2;  }#dpnl.mshanaa1 .light{background-color:#ecdce4!important;background-image:linear-gradient(225deg,#995b85 0%,#f7f7f7 29%,#f4f4f4 67%,#dbdbdb 100%);}#d0.mshanaa1 .nosel.fl.bg.{background-color:#b77c9a!important;  }#users.mshanaa1 span.uhash{text-transform:uppercase;background-image:linear-gradient(-225deg,#7b7b7b 0,#737373 29%,#ebebeb 67%,#3600ff 100%);background-size:220% auto;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation:2s linear infinite textclip;display:inline-block}
...
#upro.mshanaa1 .light.fl.pro.break {
    background-image: linear-gradient(225deg,#995b85 0%,#f7f7f7 29%,#f4f4f4 67%,#dbdbdb 100%);
...
setInterval(function () {
    if (myroom == '1885db8371dx16f0b8e5x69w81x') {
        if (msh1anaa == false) {
            msh1anaa = true;
...
#users .uzr.samo1 .d-flex.dots {
  margin-top: 7px !important;
  margin-left: 5px;
}
#users .uzr.samo1 .u-msg {
  text-align: center;
  -webkit-background-clip: text;
...
#users .uzr.samo1 {
  ...
  border: 1px solid #fff;
 background-image: url(https://up6.cc/2023/05/16852006279161.jpg);
background-size: 100%;
    
}


#users .uzr.samo1 .ustat {
...
#users .uzr.samo1 span.uhash {
  margin-right: 324px;
  margin-top: 24px;
  margin-left: 0px;
}
#users .uzr.samo1 img.co {
...
#users .uzr.samo1 .c-flex.fr {
  margin-left: -4px!important;
  float: left;
}
#users .uzr.samo1 .d-flex.fl {
  padding-right: 0px !important;
}
#users .uzr.samo1 .u-topic {
  margin-left: 5px;
}
#users .uzr.samo1 .samo_star1 {
width: 66px;
margin-top: -6px;
height: 66px;
margin-left: -5px;
...
`);
var l_itvsamo=setInterval(function(){
    if(myid!=null){
        clearInterval(l_itvsamo);
        $("#users .uzr:contains('سُـمـوٌَ')").addClass('samo1');
        $("#users .uzr.samo1 .fitimg.u-pic").append('<img class="samo_star1" src="https://up6.cc/2023/02/167579486894821.png">');
		$("#users .uzr.samo1 span.u-topic").after('<img id="mystory1" class="My_vedio1" title="ستوري" style="float: right;width: 20px;margin-top: 0px;margin-right: 5px;cursor: pointer;" src="https://i.ibb.co/47VS4nY/image.png">');
        $("#users .uzr.samo1 span.uhash, #users .uzr.samo1 img.co").hide(); 
        ...
        $("div#users .uzr.samo1 .My_vedio1").click(function(){
        $("#movon1").show();
        $('#movon1').addClass('samo1');
        ...
        $("#movon1").append('<iframe id="ifr_mov1" style="max-width: 340px;min-width: 300px;right: 0; top: 35px; left: auto;" class="modal in" role="dialog" style="z-index: 2100; display: none; style="max-width:240px;" src="https://www.youtube.com/embed/3cn6VAxFolo" allowfullscreen="" width="338" height="490" frameborder="0"></iframe>');
